...
const folder = {
  ...
  item: [
    ...
    req('Product reviews (aggregate)', 'GET', '/storefront/products/{{product_handle}}/reviews'),
    req('Product reviews (full list, Judge.me)', 'GET', '/storefront/products/{{product_handle}}/reviews/list', null, [
      { key: 'page', value: '1' },
      { key: 'perPage', value: '10' },
    ]),
    req('Submit a review (Judge.me)', 'POST', '/storefront/products/{{product_handle}}/reviews', {
      name: 'Jane Doe',
      email: 'jane@example.com',
      rating: 5,
      title: 'Great board',
      body: 'Smooth ride, highly recommend.',
    }),
